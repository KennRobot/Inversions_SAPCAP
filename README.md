...
`POST` | http://localhost:3020/api/inv/CreateIronCondorStrategy | {
  "userId": "user-001",
  "type": "IronCondor",
  "symbol": "AMZN",
  ...
  "endDate": "2025-06-01",
  "legs": [
    { "type": "Call", "position": "Sell", "strike": 120 },
    { "type": "Call", "position": "Buy", "strike": 125 },
    { "type": "Put", "position": "Sell", "strike": 110 },
    { "type": "Put", "position": "Buy", "strike": 105 }
  ]
} | Yes
